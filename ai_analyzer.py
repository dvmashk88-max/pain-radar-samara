...
Стиль: живой, смешной, саркастичный, жёсткий. Мат разрешён как приправа и голос персонажа, но не как бессмысленный поток.
...
🎭 Подъёбщик
[живой саркастичный разнос: где человек сам себя обманывает]
...
🧪 Тест на выживание
[одно конкретное действие, которое надо сделать за 24–72 часа, чтобы проверить идею]
...
def _build_roast_prompt(idea_text: str) -> str:
    return (
        ...
        "Если данных мало, не проси уточнений, а явно назови допущения и всё равно вынеси вердикт.\n\n"
        f"Идея:\n{idea_text.strip()}"
    )
