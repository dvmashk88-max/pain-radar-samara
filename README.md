...
Любое обычное текстовое сообщение бот воспринимает как идею для разбора. После первого ответа бот держит контекст разговора в памяти процесса и продолжает докапываться до клиента, денег, канала продаж и теста.
